...
try:
    ...
    print("System tray functionality not available. Install with: pip install pystray")
...
class DomainReviewerGUI:
    ...
    def setup_tray(self):
        ...
        try:
            # Load icon for tray
            if os.path.exists("domain_reviewer_icon.ico"):
                icon_image = Image.open("domain_reviewer_icon.ico")
            else:
                # Create a simple default icon
                icon_image = Image.new('RGBA', (64, 64), (52, 152, 219, 255))
            ...
            # Create tray icon
            self.tray_icon = pystray.Icon("Domain Reviewer", icon_image, "Domain Reviewer Tool", menu)
    ...
    def setup_ui(self):
        ...
        exit_button = ttk.Button(button_frame, text="Exit", command=self.quit_app)
